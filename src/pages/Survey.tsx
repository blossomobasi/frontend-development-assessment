					...
					<div className="bg-white rounded-3xl md:p-12 p-4 text-center shadow-lg">
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							{isPerfectScore ? (
								<>
									<button
										className="bg-primary hover:bg-blue-800 text-white font-semibold px-8 py-3 rounded-xl transition-colors"
									...
									<button
										...
										className="bg-white border-2 border-stone-300 text-gray-700 font-semibold px-8 py-3 rounded-xl hover:bg-gray-50 transition-colors inline-flex items-center justify-center gap-2"
									>
										<FaHome size={20} />
										Back to Home
									</button>
								...
								<>
									<button className="bg-primary hover:bg-blue-800 text-white font-semibold px-8 py-3 rounded-xl transition-colors">
										{isPerfectScore ? "Proceed to Registration" : "View Guidance"}
									</button>
									<button
										onClick={handleStartSurvey}
										className="bg-white border-2 border-gray-300 text-gray-700 font-semibold px-8 py-3 rounded-xl hover:bg-gray-50 transition-colors"
									>
										Retake Survey
									</button>
								</>
